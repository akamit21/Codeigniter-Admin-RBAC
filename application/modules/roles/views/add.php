				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<ul class="modules todo-list small-list">
							...
							<li class="lead text-uppercase"><input type="checkbox" name="component[]" value="<?= $component->component_id ?>" />&nbsp;<?= $component->component_name ?>
								<ul class="list-inline">
									<?php foreach ($permissions as $permission):
										if($permission->fk_component_id == $component->component_id): ?>
										<li class="h5 font-bold">
											<input type="checkbox" name="permission[]" value="<?= $permission->permission_id ?>" />&nbsp;<?= $permission->display_name ?>&nbsp;
