							...
							<tbody>
								...
								<?php
									...
									<tr>
										...
										<td>
											<a href="<?= site_url($this->misc->get_class_name() . '/gallery/' . $list->plant_id) ?>" class="btn btn-xs btn-info" title="Gallery">
												<i class="fa fa-picture-o fa-fw"></i>
											</a>
											<a href="<?= site_url($this->misc->get_class_name() . '/edit/' . $list->plant_id) ?>" class="btn btn-xs btn-success" title="Edit">
